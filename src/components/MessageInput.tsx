  ...
  return (
    <div className="flex items-end w-full max-w-2xl mx-auto bg-muted/60 rounded-[1.75rem] p-2 focus-within:bg-muted/80 transition-colors">
      <Textarea
        ...
        disabled={disabled}
        className="flex-1 min-h-[48px] max-h-[200px] border-0 focus-visible:ring-0 focus-visible:border-transparent resize-none font-naskh text-base py-3 px-4 shadow-none bg-transparent overflow-y-auto leading-relaxed"
